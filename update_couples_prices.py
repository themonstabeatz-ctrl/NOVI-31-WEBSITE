...
async def update_couples_prices():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print("📍 Navigating to https://massage-hub-10.preview.emergentagent.com/")
            await page.goto("https://massage-hub-10.preview.emergentagent.com/", wait_until="networkidle")
...
if __name__ == "__main__":
    ...
    print("="*60)
    print(f"Target: https://massage-hub-10.preview.emergentagent.com/")
