...
async def update_couples_prices():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print("📍 Navigating to https://spa-parallax-page.preview.emergentagent.com/")
            await page.goto("https://spa-parallax-page.preview.emergentagent.com/", wait_until="networkidle")
...
if __name__ == "__main__":
    ...
    print("="*60)
    print(f"Target: https://spa-parallax-page.preview.emergentagent.com/")
