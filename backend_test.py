...
Tests the booking API integration with https://fixprice-bug.preview.emergentagent.com
"""
...
BACKEND_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://fixprice-bug.preview.emergentagent.com')
        ...
        try:
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                response = await client.get(
                    f"https://fixprice-bug.preview.emergentagent.com/api/appointments/{appointment_id}",
                ...
                if response.status_code == 200:
                    ...
                    self.log_result(
                        ...
                        f"✅ GET /api/services returns {len(services)} services from new booking system",
                        {
                            ...
                            "booking_system_url": "https://fixprice-bug.preview.emergentagent.com"
                        }
                    )
                    return True
                else:
...
UKUPNA CENA SA POPUSTOM: {couples_data['totalPrice']:,} RSD"""
    ...
    async def run_all_tests(self):
        ...
        print(f"New Booking System: https://fixprice-bug.preview.emergentagent.com")
        print()
