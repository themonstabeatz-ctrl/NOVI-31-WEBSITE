...
Tests the booking API integration with https://massage-scheduler-3.preview.emergentagent.com
"""
        ...
        try:
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                response = await client.get(
                    f"https://massage-scheduler-3.preview.emergentagent.com/api/appointments/{appointment_id}",
                ...
                if response.status_code == 200:
                    ...
                    self.log_result(
                        ...
                        f"✅ GET /api/services returns {len(services)} services from new booking system",
                        {
                            ...
                            "booking_system_url": "https://massage-scheduler-3.preview.emergentagent.com"
                        }
                    )
                    return True
                else:
...
UKUPNA CENA SA POPUSTOM: {couples_data['totalPrice']:,} RSD"""
    ...
    async def run_all_tests(self):
        ...
        print(f"New Booking System: https://massage-scheduler-3.preview.emergentagent.com")
        print()
