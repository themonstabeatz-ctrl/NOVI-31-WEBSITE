...
Tests the booking API integration with https://bualuang-anim.preview.emergentagent.com
"""
...
BACKEND_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://bualuang-anim.preview.emergentagent.com')
        ...
        try:
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                response = await client.get(
                    f"https://bualuang-anim.preview.emergentagent.com/api/appointments/{appointment_id}",
                ...
                if response.status_code == 200:
                    ...
                    self.log_result(
                        ...
                        f"✅ GET /api/services returns {len(services)} services from new booking system",
                        {
                            ...
                            "booking_system_url": "https://bualuang-anim.preview.emergentagent.com"
                        }
                    )
                    return True
                else:
...
UKUPNA CENA SA POPUSTOM: {couples_data['totalPrice']:,} RSD"""
    ...
    async def run_all_tests(self):
        ...
        print(f"New Booking System: https://bualuang-anim.preview.emergentagent.com")
        print()
