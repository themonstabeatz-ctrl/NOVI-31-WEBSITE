...
BACKEND_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://thaibook-system.preview.emergentagent.com')
...
class ComprehensiveAPITester:
    ...
    async def test_external_service_availability(self):
        ...
        external_url = "https://thaibook-system.preview.emergentagent.com/api/appointments"
