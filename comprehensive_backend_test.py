...
BACKEND_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://thai-spa-fix.preview.emergentagent.com')
...
class ComprehensiveAPITester:
    ...
    async def test_external_service_availability(self):
        ...
        external_url = "https://thai-spa-fix.preview.emergentagent.com/api/appointments"
