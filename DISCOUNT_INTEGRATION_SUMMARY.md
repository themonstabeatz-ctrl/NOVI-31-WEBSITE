...
#### API Endpoint
```
GET https://thai-spa-booking.preview.emergentagent.com/api/services
```
...
### API Request
```javascript
const response = await fetch('https://thai-spa-booking.preview.emergentagent.com/api/services');
