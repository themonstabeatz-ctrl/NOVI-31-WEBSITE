...
ENDPOINTS:
- GET https://spabook-upgrade.preview.emergentagent.com/api/services
- POST https://spabook-upgrade.preview.emergentagent.com/api/book-appointment
...
# Test configuration
BASE_URL = "https://spabook-upgrade.preview.emergentagent.com"
