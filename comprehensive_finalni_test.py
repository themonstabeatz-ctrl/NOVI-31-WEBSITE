...
ENDPOINTS:
- GET https://relaxhub-1.preview.emergentagent.com/api/services
- POST https://relaxhub-1.preview.emergentagent.com/api/book-appointment
...
# Test configuration
BASE_URL = "https://relaxhub-1.preview.emergentagent.com"
