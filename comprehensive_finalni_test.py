...
ENDPOINTS:
- GET https://fixprice-bug.preview.emergentagent.com/api/services
- POST https://fixprice-bug.preview.emergentagent.com/api/book-appointment
...
# Test configuration
BASE_URL = "https://fixprice-bug.preview.emergentagent.com"
