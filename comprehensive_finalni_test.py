...
ENDPOINTS:
- GET https://massage-app-4.preview.emergentagent.com/api/services
- POST https://massage-app-4.preview.emergentagent.com/api/book-appointment
...
# Test configuration
BASE_URL = "https://massage-app-4.preview.emergentagent.com"
