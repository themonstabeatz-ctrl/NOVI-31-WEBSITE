...
ENDPOINTS:
- GET https://luxury-spa.preview.emergentagent.com/api/services
- POST https://luxury-spa.preview.emergentagent.com/api/book-appointment
...
# Test configuration
BASE_URL = "https://luxury-spa.preview.emergentagent.com"
