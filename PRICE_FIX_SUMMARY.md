...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://fixprice-bug.preview.emergentagent.com

# NOVO (ispravno):
REACT_APP_BACKEND_URL=https://therapist-scheduler.preview.emergentagent.com
```
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://fixprice-bug.preview.emergentagent.com"

# NOVO (ispravno):
BOOKING_API_URL="https://therapist-scheduler.preview.emergentagent.com"
```
...
```bash
curl -s https://therapist-scheduler.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://fixprice-bug.preview.emergentagent.com/massage
