...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://spa-multilingual.preview.emergentagent.com
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://spa-multilingual.preview.emergentagent.com"
...
```bash
curl -s https://spa-multilingual.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://spa-multilingual.preview.emergentagent.com/massage
