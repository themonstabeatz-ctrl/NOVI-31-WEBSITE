...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://massage-scheduler-3.preview.emergentagent.com
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://massage-scheduler-3.preview.emergentagent.com"
...
```bash
curl -s https://massage-scheduler-3.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://massage-scheduler-3.preview.emergentagent.com/massage
