...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://relax-reserve-5.preview.emergentagent.com"
...
```bash
curl -s https://relax-reserve-5.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://relax-reserve-5.preview.emergentagent.com/massage
