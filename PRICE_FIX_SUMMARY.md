...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://luxury-spa.preview.emergentagent.com
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://luxury-spa.preview.emergentagent.com"
...
```bash
curl -s https://luxury-spa.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://luxury-spa.preview.emergentagent.com/massage
