...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://multi-lang-spa-1.preview.emergentagent.com
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://multi-lang-spa-1.preview.emergentagent.com"
...
```bash
curl -s https://multi-lang-spa-1.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://multi-lang-spa-1.preview.emergentagent.com/massage
