...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://spa-booking-site-1.preview.emergentagent.com
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://spa-booking-site-1.preview.emergentagent.com"
...
```bash
curl -s https://spa-booking-site-1.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://spa-booking-site-1.preview.emergentagent.com/massage
