...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://massage-app-4.preview.emergentagent.com"
...
```bash
curl -s https://massage-app-4.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://massage-app-4.preview.emergentagent.com/massage
