...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://spabook-upgrade.preview.emergentagent.com
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://spabook-upgrade.preview.emergentagent.com"
...
```bash
curl -s https://spabook-upgrade.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://spabook-upgrade.preview.emergentagent.com/massage
