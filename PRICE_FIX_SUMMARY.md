...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://booking-system-85.preview.emergentagent.com
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://booking-system-85.preview.emergentagent.com"
...
```bash
curl -s https://booking-system-85.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://booking-system-85.preview.emergentagent.com/massage
