...
```bash
# STARO (pogrešno):
REACT_APP_BACKEND_URL=https://relaxhub-1.preview.emergentagent.com
...
```bash
# STARO (pogrešno):
BOOKING_API_URL="https://relaxhub-1.preview.emergentagent.com"
...
```bash
curl -s https://relaxhub-1.preview.emergentagent.com/api/services/single/list | \
...
Otvori: https://relaxhub-1.preview.emergentagent.com/massage
