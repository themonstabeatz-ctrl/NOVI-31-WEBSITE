...
API_BASE = "https://massage-booking-hub-1.preview.emergentagent.com/api"
...
def main():
    ...
    if updates_successful > 0:
        ...
        print()
        print("Next steps:")
        print("1. Verify prices in frontend: https://massage-booking-hub-1.preview.emergentagent.com/massage")
