...
API_BASE = "https://spa-cards-revamp.preview.emergentagent.com/api"
...
def main():
    ...
    if updates_successful > 0:
        ...
        print()
        print("Next steps:")
        print("1. Verify prices in frontend: https://spa-cards-revamp.preview.emergentagent.com/massage")
