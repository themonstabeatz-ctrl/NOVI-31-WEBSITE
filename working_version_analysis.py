...
def analyze_working_version():
    ...
    working_base = "https://booking-system-85.preview.emergentagent.com"
    ...
    possible_systems = [
        "https://booking-system-85.preview.emergentagent.com/api/services",  # Self-hosted
        "https://spabooking.emergent.host/api/services",  # My system
        "https://pozdrav-kako-si.emergent.host/api/services",  # Alternative
        "https://booking-system-85.preview.emergentagent.com/api/services"  # My version
    ]
