...
def analyze_working_version():
    ...
    working_base = "https://luxury-spa.preview.emergentagent.com"
    ...
    possible_systems = [
        "https://luxury-spa.preview.emergentagent.com/api/services",  # Self-hosted
        "https://spabooking.emergent.host/api/services",  # My system
        "https://pozdrav-kako-si.emergent.host/api/services",  # Alternative
        "https://luxury-spa.preview.emergentagent.com/api/services"  # My version
    ]
