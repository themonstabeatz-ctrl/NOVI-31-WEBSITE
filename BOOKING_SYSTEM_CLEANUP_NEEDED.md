...
curl -X DELETE https://multi-lang-spa-1.preview.emergentagent.com/api/services/{SERVICE_ID}

# Primer za prvi duplikat:
curl -X DELETE https://multi-lang-spa-1.preview.emergentagent.com/api/services/431be4cd-ca33-4a38-a72c-65c42eefe99d
```
