...
async def get_couples_individual_services():
    ...
    """
    booking_api_url = os.environ.get('BOOKING_API_URL', 'https://booking-system-85.preview.emergentagent.com')
...
1. Otvori: https://booking-system-85.preview.emergentagent.com/massage
