...
async def get_couples_individual_services():
    ...
    """
    booking_api_url = os.environ.get('BOOKING_API_URL', 'https://spabook-upgrade.preview.emergentagent.com')
...
1. Otvori: https://spabook-upgrade.preview.emergentagent.com/massage
