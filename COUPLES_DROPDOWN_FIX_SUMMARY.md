...
async def get_couples_individual_services():
    ...
    """
    booking_api_url = os.environ.get('BOOKING_API_URL', 'https://spa-parallax-page.preview.emergentagent.com')
...
1. Otvori: https://spa-parallax-page.preview.emergentagent.com/massage
