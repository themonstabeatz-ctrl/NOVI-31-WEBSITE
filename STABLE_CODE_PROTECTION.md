...
**DO NOT CHANGE TO**: `https://therapy-backend.preview.emergentagent.com` (that's the admin dashboard, not public API)
...
curl -s https://therapy-backend.preview.emergentagent.com/ | grep -q "Bua Luang" && echo "✅ Website is up"
```
