...
**DO NOT CHANGE TO**: `https://multi-lang-spa-1.preview.emergentagent.com` (that's the admin dashboard, not public API)
...
curl -s https://multi-lang-spa-1.preview.emergentagent.com/ | grep -q "Bua Luang" && echo "✅ Website is up"
```
