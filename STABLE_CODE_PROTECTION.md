...
**DO NOT CHANGE TO**: `https://spa-cards-revamp.preview.emergentagent.com` (that's the admin dashboard, not public API)
...
curl -s https://spa-cards-revamp.preview.emergentagent.com/ | grep -q "Bua Luang" && echo "✅ Website is up"
```
