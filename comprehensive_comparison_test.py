...
def main():
    ...
    working_api = "https://pricing-source-truth.preview.emergentagent.com/api/services"
    my_api = "https://pricing-source-truth.preview.emergentagent.com/api/services"
    ...
    endpoints = [
        ("Working Version", "https://pricing-source-truth.preview.emergentagent.com/api/health"),
        ("My Version", "https://pricing-source-truth.preview.emergentagent.com/api/health")
    ]
