...
def main():
    ...
    working_api = "https://therapy-backend.preview.emergentagent.com/api/services"
    my_api = "https://therapy-backend.preview.emergentagent.com/api/services"
    ...
    endpoints = [
        ("Working Version", "https://therapy-backend.preview.emergentagent.com/api/health"),
        ("My Version", "https://therapy-backend.preview.emergentagent.com/api/health")
    ]
