              ...
              {dropdownOpen.person1 && (
                <div style={{ position: 'relative' }}>
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      scrollDropdown(person1ScrollRef, 'up');
                    }}
                    style={{
                      position: 'absolute',
                      top: '8px',
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      scrollDropdown(person1ScrollRef, 'down');
                    }}
                    style={{
                      position: 'absolute',
                      bottom: '8px',
              ...
              {dropdownOpen.person2 && (
                <div style={{ position: 'relative' }}>
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      scrollDropdown(person2ScrollRef, 'up');
                    }}
                    style={{
                      position: 'absolute',
                      top: '8px',
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      scrollDropdown(person2ScrollRef, 'down');
                    }}
                    style={{
                      position: 'absolute',
                      bottom: '8px',
